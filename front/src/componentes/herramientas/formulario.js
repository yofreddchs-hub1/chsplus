...
import {genera_fromulario, crear_campos, conexiones} from '../../procesos/servicios';
...
class Formulario extends Component {
  ...
  Mas = async(valor)=>{
    ...
    const titulos= await genera_fromulario({valores:{}, campos: Form_todos(valor.form) },2)
  ...
  Guardar_agregar = async(valores, campos)=>{
    ...
    const nuevo_f = await genera_fromulario({campos:Form_origen,valores:{}})
