        ...
        <Grid container spacing={2}>
            <Grid item xs={12}>
                ...
                >
                    ...
                    {/* <iframe src={`${require('../../catalogos/CHS+ CATALOGO 2022.pdf')}#toolbar=0&navpanes=0&scrollbar=0&page=3&view=fitH,100`} height="100%" width="100%" frameborder="0" allowfullscreen></iframe> */}
                    <embed onClick={()=>console.log('Paoaooa')} src={`${require('../../catalogos/CHS+ CATALOGO 2022.pdf')}#toolbar=0&navpanes=0&scrollbar=0&pagemode=none`} type="application/pdf" width="100%" height="100%" />
                    {/* <object data={`${require('../../catalogos/CHS+ CATALOGO 2022.pdf')}#toolbar=0&navpanes=0&scrollbar=1&page=3`} height="100%" width="100%"></object> */}
                </Box>
            </Grid>
        </Grid>
