...
import { sistemachs_pantallas } from './pantallas';

const Nombre_Api='sistemachs';
export default function SistemaCHS() {
        ...
        <ThemeProvider theme={darkTheme}>
            <React.Fragment>
              {state.config.TipoMenu===undefined || state.config.TipoMenu==='0'
                ? <Principal Config={{...state.config, Logo}} Login={Login} Registro={Registro} User={state.User} Api={state.api.api} pantallas={sistemachs_pantallas}/>
                : <Principal1 Config={{...state.config, Logo}} Login={Login} Registro={Registro} User={state.User} Api={state.api.api} pantallas={sistemachs_pantallas}/>
              }
