...
const Nombre_Api='unefapostgrado';
export default function UnefaPostgrado() {
        ...
        <ThemeProvider theme={darkTheme}>
            <React.Fragment>
              {state.config.TipoMenu===undefined || state.config.TipoMenu==='0'
                ...
                : <Principal1 Config={{...state.config, Logo}} Login={Login} Registro={Registro} User={state.User} Api={state.api.api} pantallas={unefa_pantallas}/>
              }
